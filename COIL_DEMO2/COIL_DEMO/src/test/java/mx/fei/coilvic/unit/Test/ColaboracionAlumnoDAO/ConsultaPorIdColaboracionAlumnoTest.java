 ...
 * @author nmh14
 */
public class ConsultaPorIdColaboracionAlumnoTest {
    ...
    public static void configuracionGeneral() {
        ...
        try {
            ...
            Logger.getLogger(ConsultaPorIdColaboracionAlumnoTest.class.getName()).log(Level.SEVERE, null, ex);
        }
    }
    ...
    public static void eliminarConfiguracionGeneral() {
        try {
            ...
            Logger.getLogger(ConsultaPorIdColaboracionAlumnoTest.class.getName()).log(Level.SEVERE, null, excepcion);
        }
    }

    @Test
    public void TestConsultaPorIdAlumnoColaboracionAlumnoExitoso() {
        ArrayList<ColaboracionAlumno> listaResultado = new ArrayList<>();
        try {
            listaResultado = COLABORACIONALUMNO_DAO.consultarPorIdColaboracionAlumno(DEFAULT_AUXILIAR_IDCOLABORACION);
        } catch (SQLException ex) {
            Logger.getLogger(ConsultaPorIdColaboracionAlumnoTest.class.getName()).log(Level.SEVERE, null, ex);
        }
    ...
    @Test
    public void TestConsultaPorIdAlumnoColaboracionAlumnoInexistenteFallido() {
        ArrayList<ColaboracionAlumno> listaResultado = new ArrayList<>();
        try {
            listaResultado = COLABORACIONALUMNO_DAO.consultarPorIdColaboracionAlumno(DEFAULT_AUXILIAR_IDCOLABORACION_INEXISTENTE);
        } catch (SQLException ex) {
            Logger.getLogger(ConsultaPorIdColaboracionAlumnoTest.class.getName()).log(Level.SEVERE, null, ex);
        }
