 ...
 * @author nmh14
 */
public class ConsultaPorNombreYRepresentanteAcademicoExtranjeroTest {
    ...
    private static final String DEFAULT_AUXILIAR_NOMBRE_FALLIDO = "AuxiliarAnonimo61";
    private static final String DEFAULT_AUXILIAR_IDREPRESENTANTE_FALLIDO = "AuxiliarREP2324002";
    ...
    @Test
    public void testConsultarTotalAcademicoExtranjeroExitoso() {
         ArrayList<AcademicoExtranjero> listaResultado= new ArrayList<>();
        try {
            listaResultado = ACADEMICOEXTRANJERO_DAO.consultarPorNombreYRepresentanteAcademicoExtranjero
        (DEFAULT_AUXILIAR_NOMBRECOMPLETO, DEFAULT_AUXILIAR_IDREPRESENTANTE);
        } catch (SQLException ex) {
            Logger.getLogger(AcademicoRegistroTest.class.getName()).log(Level.SEVERE, null, ex);
        }
    ...
    @Test
    public void testConsultarTotalAcademicoExtranjeroInexistenFallido() {
         ArrayList<AcademicoExtranjero> listaResultado= new ArrayList<>();
        try {
            listaResultado = ACADEMICOEXTRANJERO_DAO.consultarPorNombreYRepresentanteAcademicoExtranjero
        (DEFAULT_AUXILIAR_NOMBRE_FALLIDO, DEFAULT_AUXILIAR_IDREPRESENTANTE_FALLIDO);
        } catch (SQLException ex) {
            Logger.getLogger(AcademicoRegistroTest.class.getName()).log(Level.SEVERE, null, ex);
        }
    ...
    @Test
    public void testConsultarTotalAcademicoExtranjeroNombreInexistenFallido() {
         ArrayList<AcademicoExtranjero> listaResultado= new ArrayList<>();;
        try {
            listaResultado = ACADEMICOEXTRANJERO_DAO.consultarPorNombreYRepresentanteAcademicoExtranjero
        (DEFAULT_AUXILIAR_NOMBRE_FALLIDO, DEFAULT_AUXILIAR_IDREPRESENTANTE);
        } catch (SQLException ex) {
            Logger.getLogger(AcademicoRegistroTest.class.getName()).log(Level.SEVERE, null, ex);
        }
        assertFalse(!listaResultado.isEmpty());
    ...
    @Test
    public void testConsultarTotalAcademicoExtranjeroIdRepresentanteInexistenFallido() {
         ArrayList<AcademicoExtranjero> listaResultado= new ArrayList<>();;
        try {
            listaResultado = ACADEMICOEXTRANJERO_DAO.consultarPorNombreYRepresentanteAcademicoExtranjero
        (DEFAULT_AUXILIAR_NOMBRECOMPLETO, DEFAULT_AUXILIAR_IDREPRESENTANTE_FALLIDO);
        } catch (SQLException ex) {
            Logger.getLogger(AcademicoRegistroTest.class.getName()).log(Level.SEVERE, null, ex);
        }
        assertFalse(!listaResultado.isEmpty());
