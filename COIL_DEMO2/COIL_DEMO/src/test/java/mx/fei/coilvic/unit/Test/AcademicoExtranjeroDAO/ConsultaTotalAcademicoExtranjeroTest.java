 ...
 * @author nmh14
 */
public class ConsultaTotalAcademicoExtranjeroTest {
    ...
    public static void configuracionGeneral () {
        ...
        try {
            ...
            Logger.getLogger(ConsultaTotalAcademicoExtranjeroTest.class.getName()).log(Level.SEVERE, null, ex);
        } 
    }
    ...
    public static void eliminarConfiguracionGeneral() {
        try {
            ...
            Logger.getLogger(ConsultaTotalAcademicoExtranjeroTest.class.getName()).log(Level.SEVERE, null, excepcion);
        }
    }
    ...
    public void testConsultarTotalAcademicoExtranjeroExitoso() {
        ...
        try {
            listaResultado = ACADEMICOEXTRANJERO_DAO.consultarTotalAcademicoExtranjero();
        } catch (SQLException ex) {
            Logger.getLogger(ConsultaTotalAcademicoExtranjeroTest.class.getName()).log(Level.SEVERE, null, ex);
        }
