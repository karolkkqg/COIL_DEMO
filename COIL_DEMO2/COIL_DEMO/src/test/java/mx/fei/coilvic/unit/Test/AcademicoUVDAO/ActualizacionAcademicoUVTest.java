 ...
 * @author nmh14
 */
public class ActualizacionAcademicoUVTest {
    ...
    public static void configuaracionAcademico() {
        ...
        try {
            ...
            Logger.getLogger(ActualizacionAcademicoUVTest.class.getName()).log(Level.SEVERE, null, ex);
        }
    }
    ...
    public static void eliminarConfiguracionGeneral() {
        try {
            ...
            Logger.getLogger(ActualizacionAcademicoUVTest.class.getName()).log(Level.SEVERE, null, excepcion);
        }
    }
    ...
    public void configuracionUnidad() {
        ...
        academicoUVParaPruebas = AcademicoUV.getNuevaInstancia();
        ...
        try {
            ACADEMICOUV_DAO.registrarAcademicoUV(academicoUVParaPruebas);
        } catch (SQLException excepcion) {
            Logger.getLogger(ActualizacionAcademicoUVTest.class.getName()).log(Level.SEVERE, null, excepcion);
        }
    }
    ...
    @Test
    public void testActualizacionAcademicoUVExitoso() {
        int idRegistro = -1;
        try {
            idRegistro = ACADEMICOUV_DAO.actualizarAcademicoUV(auxiliarAcademicoUVParaPruebas);
        } catch (SQLException ex) {
            Logger.getLogger(ActualizacionAcademicoUVTest.class.getName()).log(Level.SEVERE, null, ex);
        }
    ...
    @Test
    public void testActualizacionAcademicoUVMismaInformacionExitoso() {
        int idRegistro = -1;
        try {
            idRegistro = ACADEMICOUV_DAO.actualizarAcademicoUV(academicoUVParaPruebas);
        } catch (SQLException ex) {
            Logger.getLogger(ActualizacionAcademicoUVTest.class.getName()).log(Level.SEVERE, null, ex);
        }
        assertEquals(1, idRegistro);
