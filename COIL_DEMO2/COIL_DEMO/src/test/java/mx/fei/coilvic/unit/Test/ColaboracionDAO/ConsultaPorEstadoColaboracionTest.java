 ...
 * @author nmh14
 */
public class ConsultaPorEstadoColaboracionTest {
    ...
    private static final String DEFAULT_AUXILIAR_IDACOLABORACION_SINELEMENTOS = "Sin elementos EX2324000";
    ...
    @Test
    public void testConsultaPorEstadoColaboracionExitoso() {
         ArrayList<Colaboracion> listaResultado= new ArrayList<>();
        try {
            listaResultado = COLABORACION_DAO.consultarPorEstadoColaboracion(DEFAULT_AUXILIAR_ESTADO);
        } catch (SQLException ex) {
            Logger.getLogger(RegistroColaboracionTest.class.getName()).log(Level.SEVERE, null, ex);
        }
    ...
    @Test
    public void testConsultaPorEstadoColaboracionSinElementosFallido() {
         ArrayList<Colaboracion> listaResultado= new ArrayList<>();
        try {
            listaResultado = COLABORACION_DAO.consultarPorEstadoColaboracion(DEFAULT_AUXILIAR_IDACOLABORACION_SINELEMENTOS);
        } catch (SQLException ex) {
            Logger.getLogger(RegistroColaboracionTest.class.getName()).log(Level.SEVERE, null, ex);
        }
