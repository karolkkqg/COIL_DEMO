 ...
 * @author kahun
 */
public class RegistroConstanciaColaboracionAlumnoTest {
    ...
    static void configuracionGeneral(){
        ...
        auxiliarAlumnoParaPruebas = new Alumno();
        ...
        try {
            ...
            Logger.getLogger(RegistroConstanciaColaboracionAlumnoTest.class.getName()).log(Level.SEVERE, null, excpecion);
        }
    }
    ...
    public static void eliminarConfiguracionGeneral() {
        try {
            ...
            Logger.getLogger(RegistroConstanciaColaboracionAlumnoTest.class.getName()).log(Level.SEVERE, null, excepcion);
        }
    }
    ...
    public void testRegistrarConstanciaColaboracionAlumnoExitoso() {
        ...
        try {
            ...
            Logger.getLogger(RegistroConstanciaColaboracionAlumnoTest.class.getName()).log(Level.SEVERE, null, ex);
        }
