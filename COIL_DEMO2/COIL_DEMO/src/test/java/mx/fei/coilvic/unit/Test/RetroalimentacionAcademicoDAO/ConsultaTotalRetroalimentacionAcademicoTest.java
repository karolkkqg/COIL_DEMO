...
import mx.fei.coilvic.unit.Test.RetroalimentacionDAO.ConsultaTotalRetroalimentacionTest;
 ...
 * @author nmh14
 */
public class ConsultaTotalRetroalimentacionAcademicoTest {
    ...
    private static final String DEFAULT_IDCOLABORACION_AUXILIAR_ = "CN2324001 axuliar";
    ...
    private static final int DEFAULT_HORASTRABAJADAS_AUXILIAR_ = 4;
    ...
    public static void configuracionGeneral() {
        ...
        auxiliarRetroaliemntacioAcademicoParaPruebas.setIdRetroalimentacion(DEFAULT_IDRETROALIMENTACION_AUXILIAR_);
        ...
        try {
            ...
            Logger.getLogger(ConsultaTotalRetroalimentacionAcademicoTest.class.getName()).log(Level.SEVERE, null, ex);
        }
    }
    ...
    public static void eliminarConfiguracionGeneral() {
        try {
            ...
            Logger.getLogger(ConsultaTotalRetroalimentacionAcademicoTest.class.getName()).log(Level.SEVERE, null, excepcion);
        }
    }
    
    @Test
    public static void TestConsultaTotalRetroalimentacionAcademicoExitoso () {
        ArrayList<RetroalimentacionAcademico> listaResultado= new ArrayList<>();;
        try {
            listaResultado = RETROALIMENTACIONACADEMICO_DAO.consultarTotalRetroalimentacionAcademico();
        } catch (SQLException ex) {
            Logger.getLogger(ConsultaTotalRetroalimentacionAcademicoTest.class.getName()).log(Level.SEVERE, null, ex);
        }
