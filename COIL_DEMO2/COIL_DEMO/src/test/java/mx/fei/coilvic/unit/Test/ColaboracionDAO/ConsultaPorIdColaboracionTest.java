 ...
 * @author nmh14
 */
public class ConsultaPorIdColaboracionTest {
    ...
    private static final String DEFAULT_AUXILIAR_IDACOLABORACION_INEXISTENTE = "INEXISTENTEEX2324000";
    ...
    @Test
    public void testConsultaPorIdColaboracionExitoso() {
         ArrayList<Colaboracion> listaResultado= new ArrayList<>();;
        try {
            listaResultado = COLABORACION_DAO.consultarPorIdColaboracion(DEFAULT_AUXILIAR_IDACOLABORACION);
        } catch (SQLException ex) {
            Logger.getLogger(RegistroColaboracionTest.class.getName()).log(Level.SEVERE, null, ex);
        }
    ...
    @Test
    public void testConsultaPorIdColaboracionInexistenteFallido() {
         ArrayList<Colaboracion> listaResultado= new ArrayList<>();
        try {
            listaResultado = COLABORACION_DAO.consultarPorIdColaboracion(DEFAULT_AUXILIAR_IDACOLABORACION_INEXISTENTE);
        } catch (SQLException ex) {
            Logger.getLogger(RegistroColaboracionTest.class.getName()).log(Level.SEVERE, null, ex);
        }
        assertTrue(listaResultado.isEmpty());
