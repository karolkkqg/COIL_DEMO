 ...
 * @author nmh14
 */
public class ConsultaPorIdDeAlumnoTest {
    ...
    private static final String DEFAULT_AUXILIAR_IDALUMNO_FALLIDO = "AuxliarAUV2324001";
    ...
    @Test
    public void TestConsultaPorIdDeAlumnoExitoso() {
         ArrayList<Alumno> listaResultado= new ArrayList<>();
        try {
            listaResultado = ALUMNO_DAO.consultarPorIdDeAlumno(DEFAULT_AUXILIAR_IDALUMNO);
        } catch (SQLException ex) {
            Logger.getLogger(AcademicoRegistroTest.class.getName()).log(Level.SEVERE, null, ex);
        }
    ...
    @Test
    public void TestConsultaPorIdDeAlumnoInexisteFallido() {
         ArrayList<Alumno> listaResultado= new ArrayList<>();
        try {
            listaResultado = ALUMNO_DAO.consultarPorIdDeAlumno(DEFAULT_AUXILIAR_IDALUMNO_FALLIDO);
        } catch (SQLException ex) {
            Logger.getLogger(AcademicoRegistroTest.class.getName()).log(Level.SEVERE, null, ex);
        }
