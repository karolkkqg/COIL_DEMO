 ...
 * @author nmh14
 */
public class ConsultaAcademicoUVNumeroDePersonalTest {
    ...
    private static final String DEFAULT_AUXILIAR_NUMERODEPERSONAL_FALLIDO = "AuxiliarUV2324001";
    ...
    public static void configuracionGeneral() {
        ...
        try {
            ...
            Logger.getLogger(ConsultaAcademicoUVNumeroDePersonalTest.class.getName()).log(Level.SEVERE, null, ex);
        }
    }
    ...
    public static void eliminarConfiguracionGeneral() {
        try {
            ...
            Logger.getLogger(ConsultaAcademicoUVNumeroDePersonalTest.class.getName()).log(Level.SEVERE, null, excepcion);
        }
    }
    
    @Test
    public void TestConsultarPorNumeroPersonalAcademicoUVExitoso() {
         ArrayList<AcademicoUV> listaResultado= new ArrayList<>();
        try {
            listaResultado = ACADEMICOUV_DAO.consultarAcademicoUVPorId(DEFAULT_AUXILIAR_NUMERODEPERSONAL);
        } catch (SQLException ex) {
            Logger.getLogger(ConsultaAcademicoUVNumeroDePersonalTest.class.getName()).log(Level.SEVERE, null, ex);
        }
    ...
    @Test
    public void TestConsultarPorNumeroPersonalAcademicoUVInexistenFallido() {
         ArrayList<AcademicoUV> listaResultado= new ArrayList<>();
        try {
            listaResultado = ACADEMICOUV_DAO.consultarAcademicoUVPorId(DEFAULT_AUXILIAR_NUMERODEPERSONAL_FALLIDO);
        } catch (SQLException ex) {
            Logger.getLogger(ConsultaAcademicoUVNumeroDePersonalTest.class.getName()).log(Level.SEVERE, null, ex);
        }
