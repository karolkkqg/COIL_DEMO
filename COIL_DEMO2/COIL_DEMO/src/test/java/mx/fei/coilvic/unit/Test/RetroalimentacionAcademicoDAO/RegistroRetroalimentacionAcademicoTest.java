package mx.fei.coilvic.unit.Test.RetroalimentacionAcademicoDAO;
...
import mx.fei.coilvic.logica.claseconcreta.RetroalimentacionAcademicoDAO;
 ...
 * @author nmh14
 */
public class RegistroRetroalimentacionAcademicoTest {

    private static IRetroalimentacionAcademicoDAO RETROALIMENTACIONACADEMICO_DAO;
    private static RetroalimentacionAcademico retroaliemntacioAcademicoParaPruebas;
    private static RetroalimentacionAcademico auxiliarRetroaliemntacioAcademicoParaPruebas;
    ...
    private static final String DEFAULT_ESTADUANTESUFICIENTETIEMPO = "respuesta ejemplo";

    private static final String DEFAULT_IDRETROALIMENTACION_AUXILIAR = "RA2324001 auxiliar";
    private static final String DEFAULT_AUXILIAR_IDACADEMICO = "EX2324000";
    private static final String DEFAULT_AUXILIAR_ESTADUANTESUFICIENTETIEMPO = "auxiliar respuesta ejemplo";
    ...
    private static final int DEFAULT_HORASTRABAJADAS = 4;
    ...
    private static final String DEFAULT_IDCOLABORACION_AUXILIAR_ = "CN2324001";
    ...
    private static final int DEFAULT_HORASTRABAJADAS_AUXILIAR_ = 5;
    ...
    public static void configuracionGeneral() {
        ...
        RETROALIMENTACIONACADEMICO_DAO = new RetroalimentacionAcademicoDAO();
        auxiliarRetroaliemntacioAcademicoParaPruebas = RetroalimentacionAcademico.getNuevaInstancia();
        auxiliarRetroaliemntacioAcademicoParaPruebas.setIdAcademico(DEFAULT_AUXILIAR_IDACADEMICO);
        auxiliarRetroaliemntacioAcademicoParaPruebas.setIdRetroalimentacion(DEFAULT_IDRETROALIMENTACION_AUXILIAR);
        auxiliarRetroaliemntacioAcademicoParaPruebas.setEstudianteConSuficienteTiempoParaActividades(DEFAULT_AUXILIAR_ESTADUANTESUFICIENTETIEMPO);

        RETROALIMENTACION_DAO = new RetroalimentacionDAO();
        auxiliarRetroaliemntacioParaPruebas = Retroalimentacion.getNuevaInstancia();
        auxiliarRetroaliemntacioParaPruebas.setIdRetroalimentacion(DEFAULT_IDRETROALIMENTACION_AUXILIAR);
        auxiliarRetroaliemntacioParaPruebas.setIdColaboracion(DEFAULT_IDCOLABORACION_AUXILIAR_);
        ...
        try {
            ...
            RETROALIMENTACIONACADEMICO_DAO.registrarRetroalimentacionAcademico(auxiliarRetroaliemntacioAcademicoParaPruebas);
        } catch (SQLException ex) {
            Logger.getLogger(RegistroRetroalimentacionAcademicoTest.class.getName()).log(Level.SEVERE, null, ex);
        }
    }
    ...
    public static void configuracionAcademico() {
        ...
        try {
            ...
            Logger.getLogger(RegistroRetroalimentacionAcademicoTest.class.getName()).log(Level.SEVERE, null, excepcion);
        }
    }
    ...
    @BeforeAll
    public static void configuracionRetroalimentacion() {
    ...
    public static void eliminarConfiguracionGeneral() {
        try {
            ...
            RETROALIMENTACIONACADEMICO_DAO.archivarRetroalimentacionAcademico(auxiliarRetroaliemntacioAcademicoParaPruebas.getIdRetroalimentacion());
    ...
    public void configuracionUnidad() {
        retroaliemntacioAcademicoParaPruebas.setIdRetroalimentacion(DEFAULT_IDRETROALIMENTACION);
        retroaliemntacioAcademicoParaPruebas.setIdAcademico(DEFAULT_IDACADEMICO);
        retroaliemntacioAcademicoParaPruebas.setEstudianteConSuficienteTiempoParaActividades(DEFAULT_ESTADUANTESUFICIENTETIEMPO);
    }

    @AfterEach
    public void eliminarConfiguracionUnidad() {
        try {
            RETROALIMENTACIONACADEMICO_DAO.archivarRetroalimentacionAcademico(retroaliemntacioAcademicoParaPruebas.getIdRetroalimentacion());
        } catch (SQLException excepcion) {
            Logger.getLogger(RegistroRetroalimentacionAcademicoTest.class.getName()).log(Level.SEVERE, null, excepcion);
        }
    }
    ...
    @Test
    public void testRegistroRetroalimentacionAcademicoExitoso() {
        int idRegistro = -1;
        try {
            idRegistro = RETROALIMENTACIONACADEMICO_DAO.registrarRetroalimentacionAcademico(retroaliemntacioAcademicoParaPruebas);
        } catch (SQLException ex) {
            Logger.getLogger(RegistroRetroalimentacionAcademicoTest.class.getName()).log(Level.SEVERE, null, ex);
        }
    ...
    @Test
    public void testRegistroRetroalimentacionAcademicoRetroalimentacionDuplicadoFallido() {
        int idRegistro = -1;
        try {
            retroaliemntacioAcademicoParaPruebas.setIdAcademico(DEFAULT_AUXILIAR_IDACADEMICO);
            retroaliemntacioAcademicoParaPruebas.setIdRetroalimentacion(DEFAULT_IDRETROALIMENTACION_AUXILIAR);
            idRegistro = RETROALIMENTACIONACADEMICO_DAO.registrarRetroalimentacionAcademico(retroaliemntacioAcademicoParaPruebas);
        } catch (SQLException ex) {
            Logger.getLogger(RegistroRetroalimentacionAcademicoTest.class.getName()).log(Level.SEVERE, null, ex);
        }
