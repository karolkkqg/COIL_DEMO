 ...
 * @author nmh14
 */
public class ConsultaPorIdAlumnoColaboracionAlumnoTest {
    ...
    public void TestConsultaPorIdAlumnoColaboracionAlumnoExitoso () {
        ...
        try {
            listaResultado = COLABORACIONALUMNO_DAO.consultarPorIdAlumnoColaboracionAlumno(DEFAULT_AUXILIAR_IDALUMNO);
        } catch (SQLException ex) {
            Logger.getLogger(RegistroColaboracionAlumnoTest.class.getName()).log(Level.SEVERE, null, ex);
        }
    ...
    public void TestConsultaPorIdAlumnoColaboracionAlumnoInexistenteFallido () {
        ArrayList<ColaboracionAlumno> listaResultado= new ArrayList<>();
        try {
            listaResultado = COLABORACIONALUMNO_DAO.consultarPorIdAlumnoColaboracionAlumno(DEFAULT_AUXILIAR_IDALUMNO_INEXISTENTE);
        } catch (SQLException ex) {
            Logger.getLogger(RegistroColaboracionAlumnoTest.class.getName()).log(Level.SEVERE, null, ex);
        }
